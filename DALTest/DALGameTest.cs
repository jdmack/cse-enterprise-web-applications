...
namespace DALTest
{
    ...
    public class DALGameTest
    {
        ...
        public void InsertGameTest()
        {
            ...
            Assert.AreEqual(game.download_count, verifyGame.download_count);
            ...
            Assert.AreEqual(game2.download_count, verifyGame.download_count);
